...
require 'src/states/entity/player/PotState'
...
gTextures = {
    ...
    ['love']=love.graphics.newImage('graphics/hearts.png'),
...
gFrames = {
    ...
    ['love']=GenerateQuads(gTextures['love'],16,16),
...
gSounds = {
    ...
    ['power']=love.audio.newSource('sounds/Powerup13.wav','static'),
    ['potup']=love.audio.newSource('sounds/Pickup_pot14.wav','static'),
    ['potdestroy']=love.audio.newSource('sounds/Pot_destroyed.wav','static')
}