        ...
        function()
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                   ...
                   PokemonHP,PokemonATK,PokemonDEF,PokemonSPD=self.playerPokemon.HP,self.playerPokemon.attack,
                                                                     self.playerPokemon.defense,self.playerPokemon.speed
                     
                    HPadd,ATKadd,DEFadd,SPDadd=self.playerPokemon:levelUp()
                    
                    tablecalcu={
                        {
                           text= "HP ==>".. PokemonHP .."+"..HPadd.."=".. PokemonHP+HPadd
                        },
                        {
                            text="Attack ==>"..PokemonATK.."+"..ATKadd.."="..PokemonATK+ATKadd
                        },
                        {
                           text= "Defense ==>"..PokemonDEF.."+"..DEFadd.."="..PokemonDEF+DEFadd
                        },
                        {
                           text= "Speed ==>"..PokemonSPD.."+"..SPDadd.."="..PokemonSPD+DEFadd
                        }
                    }
                  
                    gStateStack:push(GameMenuState{items=tablecalcu})
                    --gStateStack:pop()
