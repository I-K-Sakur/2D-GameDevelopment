...
Stop=love.graphics.newImage('pause.png')
...
function love.keypressed(key) 
    ...
    sounds['pause']:play()
       ...
       love.graphics.draw(Stop,205,120)
       love.graphics.setFont(mediumFont)
       love.graphics.printf('press any key to continue\n \n"enter" to start',5,50,VIRTUAL_WIDTH,'center')
        push:finish()
       P=false
     S='p'
    end
...
--[[elseif   P==false and key=='p' then
    ...
    function love.load()
       Sounds = love.audio.newSource("marios_way", "static")
        Sounds['music']:play()
        end
    function love.update(dt)
